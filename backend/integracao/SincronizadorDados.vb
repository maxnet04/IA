...
Public Class SincronizadorDados
    ...
    Private Sub InserirDadosIncrementais(ultimaData As DateTime)
        ...
        Console.WriteLine($"   📅 Gerando dados de {dataInicio:dd/MM/yyyy} até {dataFim:dd/MM/yyyy} ({diasDisponiveis} dias)")
        ...
        Dim random As New Random(CInt(DateTime.Now.Ticks)) ' Seed baseado no tempo atual
