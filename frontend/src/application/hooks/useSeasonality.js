 ...
 * @param {string} productId - ID do produto ou 'ALL' para todos
 ...
 */
const useSeasonality = (productId, startDate, endDate, groupBy = 'day_of_week') => {
  ...
  useEffect(() => {
    ...
    fetchSeasonality();
  }, [productId, startDate, endDate, groupBy]);
